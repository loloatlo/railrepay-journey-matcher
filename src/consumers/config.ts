/**
 * TD-JOURNEY-007: Event Consumer Configuration
 *
...
export function createConsumerConfig(): ConsumerConfig {
  ...
  // Get service name (default to journey-matcher)
  const serviceName = process.env.SERVICE_NAME || 'journey-matcher';
...
/**
 * Validates a consumer configuration object.
 *
 * @param config - Configuration object to validate
 * @returns boolean - true if valid, false otherwise
 */
export function validateConsumerConfig(config: ConsumerConfig): boolean {
