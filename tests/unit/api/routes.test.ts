            ...
            legs: [
              {
                ...
                to: { name: 'Edinburgh Waverley', stopId: '1:EDB' },
                startTime: 1640000000000,
                endTime: 1640016000000,
                tripId: 'trip-1',
                routeId: 'route-1',
            ...
            legs: [
              {
                mode: 'RAIL',
                from: { name: 'London Kings Cross', stopId: '1:KGX' },
                to: { name: 'Newcastle', stopId: '1:NCL' },
                startTime: 1640007200000,
              ...
              {
                mode: 'RAIL',
                from: { name: 'Newcastle', stopId: '1:NCL' },
                to: { name: 'Edinburgh Waverley', stopId: '1:EDB' },
        ...
        itineraries: [
          {
            ...
            legs: [
              {
                mode: 'RAIL',
                from: { name: 'London Paddington', stopId: '1:PAD' },
                to: { name: 'Cardiff Central', stopId: '1:CDF' },
                startTime: 1640000000000,
                endTime: 1640016000000,
                tripId: 'trip-1',
                routeId: 'route-1',
            ...
            legs: [
              {
                mode: 'RAIL',
                from: { name: 'London Paddington', stopId: '1:PAD' },
                to: { name: 'Bristol Temple Meads', stopId: '1:BRI' },
                startTime: 1640003600000,
                endTime: 1640010000000,
                tripId: 'trip-2a',
                routeId: 'route-2a',
              ...
              {
                mode: 'RAIL',
                from: { name: 'Bristol Temple Meads', stopId: '1:BRI' },
                to: { name: 'Cardiff Central', stopId: '1:CDF' },
                startTime: 1640012000000,
                endTime: 1640023200000,
                tripId: 'trip-2b',
